...
class RootViewController : UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if self.sideMenuController?.isLeftViewSwipeGestureEnabled ?? false {
            // If you want left view be available by swipe you need to disable navigation controller pop gesture
